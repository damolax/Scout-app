...
export default function DataDeletionPage() {
  return <PublicPage title="Account and data deletion" intro="Scout users can permanently delete their account and connected data from inside Settings.">
    <h2>Delete from Scout</h2><ol><li>Sign in to Scout.</li><li>Open Settings.</li><li>Open the Account deletion section.</li><li>Type <code>DELETE</code> exactly and confirm.</li></ol>
