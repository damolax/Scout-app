...
export type GmailAccount = {
  ...
  health_recommended_limit?: number | null;
  health_score?: number | null;
  health_reliability?: string | null;
  owner_override_limit?: number | null;
  owner_override_active?: boolean | null;
  owner_override_until?: string | null;
  owner_override_locked?: boolean | null;
  harmful_override_streak?: number | null;
  last_harmful_override_day?: string | null;
  recovery_step?: number | null;
  last_recovery_progress_day?: string | null;
  strict_disabled_at?: string | null;
  last_health_metrics?: Record<string, unknown> | null;
