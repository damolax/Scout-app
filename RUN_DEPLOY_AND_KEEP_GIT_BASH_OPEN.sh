...
# Windows-friendly launcher for Scout v10.42.5
...
DEPLOY_SCRIPT="$ROOT_DIR/DEPLOY_V10_42_5_FULL_GIT_BASH.sh"
LIVE_URL="${SCOUT_LIVE_URL:-https://scout-app-oyeola.vercel.app}"
LOG_FILE="$HOME/Downloads/scout-v10-42-5-deploy-$(date +%Y%m%d-%H%M%S).log"

printf '\nScout v10.42.5 deployment launcher\n'
printf 'Source: %s\n' "$ROOT_DIR"
printf 'Log:    %s\n\n' "$LOG_FILE"
