...
-- Run this ONCE in a completely new Supabase project before anyone signs up.
...
-- and server-enforced five-second workspace dispatch slots.
--
...
-- APPLY ALL AUDITED UPGRADES AFTER FRESH BASE
-- =============================================================================
